import { db } from "../db";
import { mailboxAccounts, settings, users as usersTable } from "@shared/schema";
import type { MailboxVisibilityConfig, RoleName } from "@shared/schema";
import { DEFAULT_MAILBOX_VISIBILITY } from "@shared/schema";
