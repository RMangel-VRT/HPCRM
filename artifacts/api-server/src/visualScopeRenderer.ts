// @ts-ignore - canvas is optional; loaded lazily to avoid native build failures
...
import type { VisualScopeSheet, MarkupObject, MarkupPoint, SymbolType, LegendState, LegendEntry, LayerDefinition, SheetMetadata } from "@workspace/db";
import { flattenMarkupObjects, parseMarkupData } from "@workspace/db";
