...
- ✅ **Draft Management**: Complete workflow for saving, loading, and deleting drafts
  ...
  - **Delete Draft**: Trash icon button on each draft with confirmation dialog
    - Requires admin or office role
