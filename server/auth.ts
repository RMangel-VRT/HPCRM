...
export interface UserWithContext extends SelectUser {
  ...
  activeRole: "admin" | "office" | "field_manager" | "field" | "irrigation_manager" | "shop_manager" | "mapping";
...
export function setupAuth(app: Express) {
    ...
    new LocalStrategy(
      ...
      async (email, password, done) => {
        try {
          ...
          let activeRole: "admin" | "office" | "field_manager" | "field" | "irrigation_manager" | "shop_manager" | "mapping";
          ...
          if (isSuperAdminBool) {
            ...
            activeRole = activeMembership.role as "admin" | "office" | "field_manager" | "field" | "irrigation_manager" | "shop_manager" | "mapping";
          }
  ...
  app.post("/api/user/switch-company", async (req, res) => {
    ...
    let activeRole: "admin" | "office" | "field_manager" | "field" | "irrigation_manager" | "shop_manager" | "mapping" = "admin";
    if (!isSuperAdmin) {
      const membership = await storage.getCompanyUser(user.id, companyId);
      if (membership && membership.status === "active") {
        activeRole = membership.role as "admin" | "office" | "field_manager" | "field" | "irrigation_manager" | "shop_manager" | "mapping";
      }
    }
